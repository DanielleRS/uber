...
class _RaceState extends State<Race> {
  ...
  _statusOnCourse(){
    ...
    double latitudePassenger = _dataRequest["passenger"]["latitude"];
    double longitudePassenger = _dataRequest["passenger"]["longitude"];

    double latitudeDriver = _dataRequest["driver"]["latitude"];
    double longitudeDriver = _dataRequest["driver"]["longitude"];
    ...
    if(latitudeDriver <= latitudePassenger) {
      sLat = latitudeDriver;
      nLat = latitudePassenger;
    } else {
      sLat = latitudePassenger;
      nLat = latitudeDriver;
    }

    if(longitudeDriver <= longitudePassenger) {
      sLon = longitudeDriver;
      nLon = longitudePassenger;
    } else {
      sLon = longitudePassenger;
      nLon = longitudeDriver;
    }
  ...
  _displayTwoMarkers(LatLng latLngDriver, LatLng latLngPassenger){
    double pixelRatio = MediaQuery.of(context).devicePixelRatio;
